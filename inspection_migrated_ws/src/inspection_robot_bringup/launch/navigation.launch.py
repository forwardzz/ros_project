    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=[
                ...
                "/inspection_migrated_ws/maps/inspection_regions.yaml",
            ],
        ),
        DeclareLaunchArgument("mission_home_x", default_value="0.0"),
        DeclareLaunchArgument("mission_home_y", default_value="0.0"),
        DeclareLaunchArgument("mission_home_yaw", default_value="0.0"),
        ...
        Node(
            package="inspection_robot_mission",
            executable="mission_manager",
            name="mission_manager",
            output="screen",
            parameters=[{
                "inspection_regions_path": LaunchConfiguration("regions"),
                "mission_home_x": LaunchConfiguration("mission_home_x"),
                "mission_home_y": LaunchConfiguration("mission_home_y"),
                "mission_home_yaw": LaunchConfiguration("mission_home_yaw"),
            }],
        ),
        ...
        Node(package="nav2_controller", executable="controller_server", name="controller_server", output="screen",
             parameters=[nav2_params], remappings=[NAV_COMMAND_REMAP]),
        ...
        Node(package="nav2_velocity_smoother", executable="velocity_smoother", name="velocity_smoother", output="screen",
             parameters=[nav2_params], remappings=[NAV_COMMAND_REMAP, ("/cmd_vel_smoothed", "/cmd_vel_auto")]),
